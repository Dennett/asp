...
latex_documents = [
    (master_doc, 'asp.tex', 'asp Documentation',
     'Michael Ramsey', 'manual'),
]
...
man_pages = [
    (master_doc, 'asp', 'asp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'asp', 'asp Documentation',
     author, 'asp', 'One line description of project.',
     'Miscellaneous'),
]
